...
import { ChevronLeft, Heart, Shield, Zap, Globe } from "lucide-react"
      ...
      <main className="flex-1 px-8 pt-4 pb-20 space-y-12">
        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-6 bg-white/40 backdrop-blur-xl border border-white/40 rounded-[2rem] space-y-3">
        ...
        <footer className="pt-10 flex flex-col items-center gap-4 opacity-40">
