      ...
      <header className="flex flex-col items-center pt-8 pb-16 px-6 shrink-0 relative bg-[#3BC1A8]">
        <div className="relative mb-4">
          <Avatar className={cn(
            ...
            isVIP && "ring-4 ring-amber-400 ring-offset-4 ring-offset-[#3BC1A8]"
          )}>
        ...
        <div className="text-center space-y-1 mb-4">
          ...
          <p className="text-white/60 text-[9px] font-black capitalize tracking-[0.2em]">
            {isVIP ? "VIP Elite Member" : "Official Profile"}
          </p>
        </div>
      ...
      <main className="flex-1 px-6 space-y-8 pb-44 -mt-10 relative z-10">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-[10px] font-black text-primary capitalize tracking-[0.3em]">Growth & Status</h2>
            <div className="h-px flex-1 bg-primary/10 ml-4" />
          </div>
          <div className="grid grid-cols-1 gap-2.5">
            <button 
              onClick={() => router.push('/profile/boost')} 
              className="w-full h-16 rounded-[1.5rem] bg-gradient-to-r from-orange-500 to-amber-500 flex items-center px-5 gap-4 active:scale-[0.98] transition-all shadow-xl shadow-orange-500/20"
            >
              <div className="w-11 h-11 rounded-xl bg-white/20 flex items-center justify-center">
                <Rocket className="w-5 h-5 text-white animate-pulse" />
              </div>
              <div className="flex-1 text-left text-white">
                <span className="font-black tracking-tight text-[13px] block">Boost Profile</span>
                <span className="opacity-60 text-[9px] font-bold mt-1 block">Get 10x more visitors now</span>
              </div>
            ...
            >
              <div className="w-11 h-11 rounded-xl bg-amber-400 flex items-center justify-center">
                <Star className="w-5 h-5 text-zinc-900 fill-current" />
              </div>
              <div className="flex-1 text-left">
                <span className="text-white font-black tracking-tight text-[13px] block">VIP Center</span>
                <span className="text-amber-400/60 text-[9px] font-bold mt-1 block">Unlock exclusive elite perks</span>
              </div>
